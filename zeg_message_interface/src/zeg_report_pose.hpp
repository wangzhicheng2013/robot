#ifndef SRC_ZEG_REPORT_POSE_HPP_
#define SRC_ZEG_REPORT_POSE_HPP_
...
class zeg_report_pose {
public:
	bool init() {
		config_.sock_type = ZMQ_PUSH;
		config_.addr = zeg_config::get_instance().pose_report_address.c_str();
	...
	bool report_pose(rpc_conn conn, const robot_pose &pose) {
...
#endif /* SRC_ZEG_REPORT_POSE_HPP_ */
