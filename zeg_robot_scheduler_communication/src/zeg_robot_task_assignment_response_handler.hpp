#ifndef SRC_ZEG_ROBOT_TASK_ASSIGNMENT_RESPONSE_HANDLER_HPP_
#define SRC_ZEG_ROBOT_TASK_ASSIGNMENT_RESPONSE_HANDLER_HPP_
#include "response_handler.hpp"
#include "zeg_robot_communicate_operation.hpp"
namespace zeg_robot_scheduler_communication {
class zeg_robot_task_assignment_response_handler: public response_handler
{
public:
	zeg_robot_task_assignment_response_handler() = default;
	virtual ~zeg_robot_task_assignment_response_handler() = default;
...
#endif /* SRC_ZEG_ROBOT_TASK_ASSIGNMENT_RESPONSE_HANDLER_HPP_ */
